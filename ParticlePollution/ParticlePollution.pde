...
// Info Graph - Input Variables
float[] pm25InfoLocation1, pm25InfoLocation2;
float[] windSpeedInfoLocation1, windSpeedInfoLocation2; 
float[] windDirectionInfoLocation1, windDirectionInfoLocation2;
String[] arrayStringDate;  
...
void draw() {
  ...
  if (!getStartDate){   
    ...
    pm25InfoLocation1 = new float[totalDays];
    pm25InfoLocation2 = new float[totalDays]; 
    windSpeedInfoLocation1 = new float[totalDays];
    windSpeedInfoLocation2 = new float[totalDays];
    windDirectionInfoLocation1 = new float[totalDays];
    windDirectionInfoLocation2 = new float[totalDays];
    arrayStringDate = new String[totalDays];
...
void keyPressed() {
  ...
  } else if (goingToStart && key == ENTER || key == RETURN) {
